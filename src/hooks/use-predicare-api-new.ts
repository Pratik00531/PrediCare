...
// Example usage of all hooks together
export const usePredicareAPI = () => {
  ...
  return {
    ...
    // Core medical features (transcription removed)
    analyzeImage,
    synthesizeSpeech,
    consultation,
    ...
    // Utility functions
    isLoading: healthCheck.isLoading || analyzeImage.isPending || synthesizeSpeech.isPending || consultation.isPending,
    hasError: healthCheck.isError,
  };
};
